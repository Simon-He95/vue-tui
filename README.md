...
| `@simon_he/vue-tui/agent/mermaid`           | Experimental | Agent namespace optional `beautiful-mermaid` bridge: adaptive `TMermaid`、`TMermaidText`、`TMermaidImage`                               |
...
| Mermaid        | `@simon_he/vue-tui/mermaid`                 | `TMermaid`（adaptive，图片→ANSI→源码）、`TMermaidText`、`TMermaidImage`、`beautifulMermaidRenderer`                                                                                              |
...
| Agent Mermaid  | `@simon_he/vue-tui/agent/mermaid`           | `TMermaid`（adaptive，图片→ANSI→源码）、`TMermaidText`、`TMermaidImage`、`beautifulMermaidRenderer`                                                                                              |
