...
| <code>h</code>                 | <code>number</code>                | —                                        | 是   | —                                                                                                                                                                                                                                                     |
| <code>zIndex</code>            | <code>number</code>                | <code>0</code>                           | 否   | —                                                                                                                                                                                                                                                     |
| <code>source</code>            | <code>TTranscriptDataSource</code> | —                                        | 是   | Transcript source. When `getRowKey` and `getRowVersion` are both provided,<br>unchanged rows can skip `getRow()`. The row version must change whenever<br>rendered content, segments, styles, actions, hit regions, or selectable<br>text can change. |
