...
export const AGENT_CONSOLE_MEASUREMENT_INPUTS = [
  ...
  "examples/agent-console/src/theme.ts",
  "examples/agent-console/src/keymap.ts",
  "examples/shared/text-utils.ts",
  "examples/agent-console/src/style.css",
  "examples/agent-console/index.html",
  "examples/agent-console/package.json",
  "examples/agent-console/vite.config.ts",
  "package.json",
  "pnpm-lock.yaml",
  "tsdown.config.mjs",
  "scripts/build-cjs.mjs",
  "scripts/run-build-checked.mjs",
...
export const AGENT_CONSOLE_VERIFICATION_INPUTS = [
  ...
  "scripts/agent-console-profile-evidence.ts",
